# FIXME, this script is copied from github.com/duckdb/duckdb/scripts/regression_test_runner.py,
#        only the root-dir param was added here, so this script can be removed once that is available upstream
